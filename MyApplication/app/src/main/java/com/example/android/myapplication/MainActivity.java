...
public class MainActivity extends ActionBarActivity {
    ...
    private void displayToast(CharSequence text)
    {
        ...
        Toast ts = Toast.makeText(context, text, Toast.LENGTH_SHORT);
        ts.setGravity(Gravity.BOTTOM|Gravity.CENTER, 0, 0);
        ts.show();
    }
    ...
    public void launchApp6(View view) {
        ...
        CharSequence text = "This Button will launch CAPSTONE PROJECT";
        displayToast(text);
    }
}
